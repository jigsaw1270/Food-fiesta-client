    ...
    return(
       <Container className='mx-auto'>
        ...
        <h1           className='mx-auto text-center'>Gallery</h1>
            ...
            <Col md={6} >
                <img src={food2} className="img-fluid mt-4 mx-auto img-fluid" alt="" style={{maxHeight:"500px"}}></img>
                </Col>
            
                <Col md={6}>
                <img src={food4} className="img-fluid mt-4 mx-auto img-fluid" alt="" style={{maxHeight:"500px"}}></img>
            </Col>
        </Row>
    </Container>
